...
//===----------------------------------------------------------------------===//
#ifndef INCLUDE_BELLEROPHON_TRUNC_APRX_TECHNIQUE_H_
#define INCLUDE_BELLEROPHON_TRUNC_APRX_TECHNIQUE_H_
...
class TruncAprxTechnique : public ::bellerophon::core::AprxTechnique
{
  public:
  
    
    // Default ctor
    TruncAprxTechnique(unsigned id, const ::std::string opId, const ::std::string lhs, const ::std::string rhs, const ::std::string ty);
