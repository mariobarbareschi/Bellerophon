...
/******************************************************************************
 * @file   EvoAprxTechnique.h
 * @author Salvatore Barone
 * @date   25 Mar 2021
 * @brief  Implementation for the apprx Contexts of EvoApprox library
 ******************************************************************************/

#ifndef INCLUDE_BELLERO_EVOAPRXCONTEXT_H_
#define INCLUDE_BELLERO_EVOAPRXCONTEXT_H_
...
class EvoAprxContext : public bellerophon::core::AprxContext {
public:
  
  EvoAprxContext (bellerophon::core::AprxContextIdTy id, const ::std::string& desc, int grade = 64) : AprxContext(id,desc), maxApproxGrade(grade) {}
  
  /// \brief destructor  
  virtual ~EvoAprxContext(){}
  ...
  {
    EvoApproxLib::EvoAprxContext *r = new EvoApproxLib::EvoAprxContext(rhs.getId(),rhs.getDesc());
