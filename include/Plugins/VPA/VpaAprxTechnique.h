...
//===----------------------------------------------------------------------===//
#ifndef INCLUDE_BELLEROPHON_VPAAPRXTECHNIQUE_H_
#define INCLUDE_BELLEROPHON_VPAAPRXTECHNIQUE_H_
...
class VpaAprxTechnique : public ::bellerophon::core::AprxTechnique 
{
public:
  // Default ctor
